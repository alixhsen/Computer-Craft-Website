...
{
    public class AddLaptopModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            int add = new DAL().AddNewLaptop(serialNumber, name, brandId, supplierId, price, quantity,description, image, ram, memory, cpu, display, color, os, touchScreen);


            if (add == 0)
            {
                TempData["Message"] = "Laptop added successfully!";
