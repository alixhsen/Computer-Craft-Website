...
{
    public class DashboardSecurityModel : PageModel
    {
        public List<AdminProduct> SecurityList = new List<AdminProduct>();
        public string admin;
        public void OnGet()
        {
            ...
            {
                SecurityList = new DAL().GetAllSecurityAdmin();
            }
        }
        ...
        public void OnPostDelete(string id)
        {
            ...
            Response.Redirect("/AdminDashboard/DashboardSecurity");
        }
    }
}
