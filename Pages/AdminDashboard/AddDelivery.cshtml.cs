...
namespace Computer_Craft.Pages.AdminDashboard
{
    public class AddDeliveryModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            int add = new DAL().AddDelivery(firstName, lastName, email, phoneNumber, country, region, town, street, building, floorNb, nationalID);

            if (add == 0)
            {
                TempData["Message"] = "Delivery added successfully!";
